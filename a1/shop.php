        ...
        <div class="shop-gallery">
            <a href="product.php">
                <div class="shop-item">
                    ...
                    <p>The signature coffee is a staple, you can't go wrong here.</p>
                </div>
            </a>
            <a href="product.php">
                <div class="shop-item">
                    ...
                    <h1>Grandma's Best Brownies</h1>
                    <p>Grandma makes the best brownies! Come and grab one of your favorites!</p>
                </div>
            </a>
            <a href="product.php">
                <div class="shop-item">
                    ...
                    <h1>A Very Warm Chocolate</h1>
                    <p>This is an absolute essential for any visit to the Cafe, come and grab a cuppa!</p>
                </div>
            </a>
        </div>
    </main>
