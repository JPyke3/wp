        ...
        <div class="content-block">
            <div class="checkout-wrapper">
                <div>
                    ...
                    ?>
                        <div class="shopping-cart-item-checkout">
                            <div style="min-width: 300px">
                                <p style="max-width: 250px;"><?php echo $item[3][2] ?> (<?php echo $item[1] ?>)</p>
                ...
                <form method="POST" action="receipt.php" style="min-width: 250px;">
                    <h1>Checkout</h1>
                    <div class="checkout-form">
                        ...
                        <label style="padding-bottom: 16px" for="ccn">
                            Credit Card Number
                            <input id="ccn" type="tel" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="19" placeholder="xxxx xxxx xxxx xxxx" name="ccn" required />
                        </label>
                        <input style="align-self: center" type="submit" />
                    </div>
                </form>
